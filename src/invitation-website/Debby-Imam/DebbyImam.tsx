...
function DebbyImam() {
  ...
  return (
    ...
    <div className='bg-slate-900 h-screen w-full text-white flex justify-center items-center flex-col p-10 gap-5 text-center'>
      <h1 className='font-bold text-2xl  md:text-3xl'>Selamat Datang di Undangan Debby & Imam</h1>
      ...
      <Link to={`https://www.versdesign.org/Web-Invitation/Debby-imam/?to=${to}`} className='bg-green-500 p-2 rounded-md mt-4 hover:bg-white hover:text-black transition-all duration-300 cursor-pointer'>
